...
ActiveRecord::Schema.define(version: 20170503013734) do
  ...
  create_table 'bets_competitors', id: false, force: :cascade do |t|
    ...
    t.index %w[competitor_id bet_id],
            name: 'index_bets_competitors_on_competitor_id_and_bet_id',
            unique: true, using: :btree
    t.index ['competitor_id'], name: 'index_bets_competitors_on_competitor_id',
                               using: :btree
  end
  ...
  create_table 'bets_grands', id: false, force: :cascade do |t|
    ...
    t.index %w[grand_id bet_id],
            name: 'index_bets_grands_on_grand_id_and_bet_id',
            unique: true, using: :btree
  ...
  create_table 'make_ups', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer  'selection'
    t.index %w[grand_id bet_id], name: 'index_make_ups_on_grand_id_and_bet_id',
                                 unique: true, using: :btree
  end
  ...
  create_table 'parts', force: :cascade do |t|
    ...
    t.datetime 'updated_at',    null: false
    t.index %w[competitor_id bet_id],
            name: 'index_parts_on_competitor_id_and_bet_id',
            unique: true, using: :btree
  end
  ...
  create_table 'user_user_bets', id: false, force: :cascade do |t|
    ...
    t.index ['user_bet_id'], name: 'index_user_user_bets_on_user_bet_id',
                             using: :btree
